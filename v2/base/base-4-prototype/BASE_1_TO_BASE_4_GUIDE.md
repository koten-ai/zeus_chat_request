...
| **base-4-prototype** | Diet: one Terminate table + multi-round Client bible | `v2/base/base-4-prototype/` |
...
base-3-prototype  (*.txt diet surface — same ideas as base-2)
   ...
   ▼
base-4-prototype  (JSON + text — current prototype tip)
```
...
| **base-4-prototype** | `chat_request_<mode>_base-4.json` + `.txt` | `…_analytics_base-4.json` |
...
| base-4-prototype | JSON | ~27 KB |
| base-4-prototype | text | ~24 KB |
...
| Need | base-1 | base-4 |
| --- | --- | --- |
| What is a catalog | repo `CHAT_REQUEST.md` | + [BIBLE.md](BIBLE.md) |
| Assembled prompt | `PROMPT_ASSEMBLY.md` | Bible §1 |
