...
**Related:** [BASE_1_TO_BASE_4_GUIDE.md](BASE_1_TO_BASE_4_GUIDE.md) · [BIBLE.md](BIBLE.md) · [INSPECTOR.md](INSPECTOR.md)
...
*Captured after the first base-1 → base-4 design/migration pass (catalog diet, Client model, inspector dual-BASE). Update this file when base-5 lands with anything that surprised you.*
